...
layout = html.Div([
    ...
    html.H1("Sehwan Dashboard", className="dashboard-title"),
...
@callback(
    Output("sehwan-map-reset", "data"),
    Input("reset-sehwan-map-btn", "n_clicks"),
...
@callback(
    Output("sehwan-map", "center"),
    Output("sehwan-map", "zoom"),
    Input("sehwan-map-reset", "data"),
    prevent_initial_call=True
)
