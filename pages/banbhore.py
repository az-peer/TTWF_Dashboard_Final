...
layout = html.Div([
    ...
    html.H1("Banbhore Dashboard", className="dashboard-title"),
...
@callback(
    Output("banbhore-map-reset", "data"),
    Input("reset-banbhore-map-btn", "n_clicks"),
...
@callback(
    Output("banbhore-map", "center"),
    Output("banbhore-map", "zoom"),
    Input("banbhore-map-reset", "data"),
    prevent_initial_call=True
)
