...
# register Karachi path

layout = html.Div([
    dcc.Location(id="school-redirect", refresh=True),
    html.H1("Mirpurckhas Dashboard", className="dashboard-title"),
...
@callback(
    Output("mirpurkhas-map-reset", "data"),
    Input("reset-mirpurkhas-map-btn", "n_clicks"),
...
@callback(
    Output("mirpurkhas-map", "center"),
    Output("mirpurkhas-map", "zoom"),
    Input("mirpurkhas-map-reset", "data"),
    prevent_initial_call=True
)
