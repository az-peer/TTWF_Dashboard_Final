...
layout = html.Div([
    ...
    html.H1("Sukkur Dashboard", className="dashboard-title"),
...
@callback(
    Output("sukkur-map-reset", "data"),
    Input("reset-sukkur-map-btn", "n_clicks"),
...
@callback(
    Output("sukkur-map", "center"),
    Output("sukkur-map", "zoom"),
    Input("sukkur-map-reset", "data"),
    prevent_initial_call=True
)
