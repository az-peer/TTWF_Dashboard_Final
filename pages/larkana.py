...
layout = html.Div([
    ...
    html.H1("Larkana Dashboard", className="dashboard-title"),
...
@callback(
    Output("larkana-map-reset", "data"),
    Input("reset-larkana-map-btn", "n_clicks"),
...
@callback(
    Output("larkana-map", "center"),
    Output("larkana-map", "zoom"),
    Input("larkana-map-reset", "data"),
    prevent_initial_call=True
)
